...
export const PROGRAMS_DATA = [
    {
      ...
      imageSrc: '/assets/mentorship and carer guidance.jpg', // User needs to add this image
    ...
    },
    {
      ...
      imageSrc: '/assets/student awards.jpg', // User needs to add this image
    ...
    },
    {
      ...
      imageSrc: '/assets/girls dignity project.jpg', // User needs to add this image
    ...
    },
    {
      ...
      imageSrc: '/assets/scholarships.jpg', // User needs to add this image
