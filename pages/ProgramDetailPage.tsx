...
const ProgramDetailPage: React.FC = () => {
  ...
  if (!program) {
    return (
      <div className="py-20 text-center">
        ...
        <Link
          to="/programs"
          className="mt-6 inline-block bg-bright-blue-600 text-white font-bold py-3 px-6 rounded-lg hover:bg-bright-blue-700 transition"
        >
  ...
  return (
    <AnimatedPage>
      <Helmet>
        <title>{program.title} | Smart Education Kenya</title>
        <meta name="description" content={program.longDescription.slice(0, 150)} />
      </Helmet>
      ...
      <div className="bg-white">
        ...
        >
          ...
          <div className="relative z-10 container mx-auto px-6 h-full flex flex-col items-center justify-center text-center text-white">
            ...
            <span className="sr-only">{program.title} program banner</span>
          </div>
        </div>
        ...
        <div className="py-12 md:py-20">
          <div className="container mx-auto px-6 max-w-4xl">
            <div className="bg-gray-50 p-8 rounded-lg shadow-lg">
              ...
              <p className="text-gray-700 leading-relaxed text-lg">{program.longDescription}</p>
            ...
            <div className="text-center mt-12">
              <Link
                to="/programs"
                className="inline-block bg-gray-700 text-white font-bold py-3 px-8 rounded-lg hover:bg-gray-800 transition transform hover:scale-105"
              >
