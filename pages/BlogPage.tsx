      ...
      <div className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 mt-4 max-w-3xl mx-auto">Stories, insights, and updates from the heart of our mission.</p>
          </div>
          <div className="max-w-4xl mx-auto space-y-12">
            {BLOG_POSTS.map((post) => (
              <div key={post.id} className="bg-gray-50 rounded-lg shadow-lg overflow-hidden md:flex transform hover:-translate-y-2 transition-transform duration-300">
