          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
                <div className="bg-white p-8 rounded-lg shadow-xl">
                    ...
                    <p className="text-gray-700 mb-2"><strong>Email:</strong> <a href="mailto:starletlucky71@gmail.com" className="text-bright-blue-600 hover:underline">starletlucky71@gmail.com</a></p>
